...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns="http://bio.agents" xsi:schemaLocation="http://bio.agents/resources/bioagents-1.4/bioagents-1.4.xsd" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xmlns:owl="http://www.w3.org/2002/07/owl#" xmlns:rdfs="http://www.w3.org/2000/01/rdf-schema#" xmlns:rdf="http://www.w3.org/1999/02/22-rdf-syntax-ns#">
    ...
    <xsl:template match="/*">
        <resources xmlns="http://bio.agents" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xsi:schemaLocation="http://bio.agents bioagents-1.4.xsd">
        <resource>
                <name>
<!--
...
-->
                ...
                <xsl:for-each select="$topics//agent[@name=current()/head/name/text()]/topic">
                    <topic uri="{text()}">
                ...
                <function>
                    <xsl:for-each select="$operations//agent[@name=current()/head/name/text()]/operation">
